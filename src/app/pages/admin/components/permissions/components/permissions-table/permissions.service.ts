...
export class PermissionsService {
    ...
    addPermissions = (permissions: PermissionsInterface): Observable<any> =>  {
        this.actionUrl = `${this._configuration.ServerWithApiUrl}AgregarPermiso`;
        const toAdd = JSON.stringify(permissions);
    ...
    editPermissions = (permissions: PermissionsInterface): Observable<any> =>  {
