...
@Component({
  ...
  styleUrls: [('./permissions-edit-modal.component.scss')],
  templateUrl: './permissions-edit-modal.component.html'
})

export class PermissionsEditModalComponent implements OnInit {
  ...
  onSubmit(values: PermissionsInterface): void {
    this.submitted = true;
    if (this.form.valid) {
      this.service
  ...
  private showToast(data: any, values: PermissionsInterface) {
