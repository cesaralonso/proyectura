...
@Component({
  ...
  styleUrls: [('./permissions-add-modal.component.scss')],
  templateUrl: './permissions-add-modal.component.html'
})

export class PermissionsAddModalComponent implements OnInit {
