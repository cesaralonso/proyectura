...
export class CategoriesAddModalComponent implements OnInit {
  ...
  onSubmit(values: CategoriesInterface): void {
    this.submitted = true;
  ...
  private showToast(data: any, values: CategoriesInterface) {
