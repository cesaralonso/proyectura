...
export class CategoriesService {
    ...
    addCategories = (categories: CategoriesInterface): Observable<any> =>  {
        this.actionUrl = `${this._configuration.ServerWithApiUrl}AgregarPermiso`;
        const toAdd = JSON.stringify(categories);
    ...
    editCategories = (categories: CategoriesInterface): Observable<any> =>  {
