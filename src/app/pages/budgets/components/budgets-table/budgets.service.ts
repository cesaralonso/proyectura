...
export class BudgetsService {
    ...
    addBudgets = (budgets: BudgetsInterface): Observable<any> =>  {
        this.actionUrl = `${this._configuration.ServerWithApiUrl}AgregarPermiso`;
        const toAdd = JSON.stringify(budgets);
    ...
    editBudgets = (budgets: BudgetsInterface): Observable<any> =>  {
