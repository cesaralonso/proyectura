...
@Component({
  ...
  styleUrls: [('./costs-edit-modal.component.scss')],
  templateUrl: './costs-edit-modal.component.html'
})

export class CostsEditModalComponent implements OnInit {
  ...
  onSubmit(values: CostsInterface): void {
    this.submitted = true;
    if (this.form.valid) {
      this.service
        .editCosts(values)
  ...
  private showToast(data: any, values: CostsInterface) {
