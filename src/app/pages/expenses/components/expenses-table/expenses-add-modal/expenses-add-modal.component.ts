...
@Component({
  ...
  styleUrls: [('./expenses-add-modal.component.scss')],
  templateUrl: './expenses-add-modal.component.html'
})

export class ExpensesAddModalComponent implements OnInit {
  ...
  onSubmit(values: ExpensesInterface): void {
    this.submitted = true;
  ...
  private showToast(data: any, values: ExpensesInterface) {
