...
export class ReportsService {
    ...
    addReports = (reports: ReportsInterface): Observable<any> =>  {
        this.actionUrl = `${this._configuration.ServerWithApiUrl}AgregarPermiso`;
        const toAdd = JSON.stringify(reports);
    ...
    editReports = (reports: ReportsInterface): Observable<any> =>  {
